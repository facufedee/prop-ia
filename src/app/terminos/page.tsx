...
export const metadata: Metadata = {
    title: 'Términos y Condiciones | PROP-IA',
    description: 'Términos y condiciones de uso de la plataforma PROP-IA. Derechos, obligaciones y marco legal del servicio.',
    alternates: {
        canonical: 'https://prop-ia.com/terminos',
    },
};
        ...
        <div className="min-h-screen bg-gray-50 py-20 px-4 md:px-8">
            <div className="max-w-4xl mx-auto space-y-12">
                ...
                <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 text-gray-600 leading-relaxed">
                    <p className="mb-4">
                        Bienvenido a <strong>PROP-IA</strong>. Estos Términos y Condiciones ("Términos") rigen el acceso y uso de nuestra plataforma de servicios inmobiliarios y herramientas de inteligencia artificial.
                    </p>
                    <p>
                ...
                <div className="grid gap-8">
                    ...
                    <section className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            Este Acuerdo constituye un contrato legalmente vinculante entre usted ("Usuario", "Usted") y PROP-IA ("Nosotros", "Plataforma"). El uso de la plataforma implica la aceptación plena y sin reservas de todas las disposiciones incluidas en este documento, así como de nuestra Política de Privacidad y Política de Cookies.
                        </p>
                    </section>
                    ...
                    <section className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
                        ...
                        <p className="text-gray-600 mb-4">
                            PROP-IA proporciona herramientas tecnológicas para el sector inmobiliario, que incluyen pero no se limitan a:
                        </p>
                    ...
                    <section className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            Usted conserva los derechos sobre los datos y archivos que carga en la plataforma (fotos de propiedades, datos de clientes). Sin embargo, garantiza que posee los derechos necesarios sobre dicho contenido y que su publicación no infringe derechos de terceros ni leyes vigentes. PROP-IA no se hace responsable por la veracidad o legalidad del contenido cargado por los usuarios.
                        </p>
                    </section>
                    ...
                    <section className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
                        ...
                        <p className="text-gray-600 mb-4 leading-relaxed">
                            PROP-IA ofrece sus servicios "tal cual" y "según disponibilidad". Aunque nos esforzamos por garantizar la precisión de nuestras tasaciones y la estabilidad del sistema, no garantizamos que el servicio sea ininterrumpido o libre de errores.
                        </p>
                        <p className="text-gray-600 leading-relaxed">
                            En la máxima medida permitida por la ley, PROP-IA no será responsable por daños indirectos, incidentales o consecuentes (incluyendo pérdida de beneficios o datos) derivados del uso del servicio. Las tasaciones generadas por IA son estimaciones referenciales y no reemplazan el juicio de un tasador profesional matriculado.
                        </p>
                    </section>
