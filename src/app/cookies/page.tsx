...
export const metadata: Metadata = {
    ...
    description: 'Información detallada sobre el uso de cookies en PROP-IA. Transparencia sobre cómo y por qué utilizamos tecnologías de rastreo.',
    alternates: {
        canonical: 'https://prop-ia.com/cookies',
    },
};
        ...
        <div className="min-h-screen bg-gray-50 py-20 px-4 md:px-8">
            <div className="max-w-4xl mx-auto space-y-12">
                ...
                <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 text-gray-600 leading-relaxed">
                    <p className="mb-4">
                        En <strong>PROP-IA</strong>, creemos en ser claros y abiertos sobre cómo recopilamos y usamos los datos relacionados con usted. Esta política de cookies proporciona información detallada sobre cómo y cuándo utilizamos cookies.
                    </p>
                    <p>
