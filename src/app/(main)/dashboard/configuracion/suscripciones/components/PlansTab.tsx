...
export default function PlansTab({ onEditingChange }: PlansTabProps) {
                                ...
                                <div className="relative">
                                    ...
                                    {openMenuId === plan.id && (
                                        <>
                                            ...
                                            />
                                            <div className="absolute right-0 top-full mt-1 w-40 bg-white rounded-lg shadow-xl border border-gray-100 py-1 z-40">
                                                <button
                                                    type="button"
