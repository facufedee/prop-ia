...
export const LOCATION_DATA: Record<string, { ciudades: string[]; barrios: string[] }> = {
    "Capital Federal": {
    ...
    // ... all other provinces from original file
    "Buenos Aires": {
    ...
    "Mendoza": {
        ciudades: ["Mendoza", "Godoy Cruz", "Maipü", "Luján de Cuyo", "San Rafael"],
